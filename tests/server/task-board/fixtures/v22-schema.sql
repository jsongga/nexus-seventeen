...
CREATE TABLE notifications (
  ...
  kind TEXT NOT NULL CHECK (kind IN ('park_aged', 'park_auto_abandoned')),
...
CREATE TABLE park_records (
  ...
  work_item_id TEXT NOT NULL REFERENCES work_items(work_item_id) ON DELETE RESTRICT,
  category TEXT NOT NULL CHECK (category IN ('open_question', 'planning_run_failed', 'design_run_failed', 'hazardous_without_pipeline', 'plan_rejected_twice', 'bright_line', 'scope_violation')),
  reason TEXT NOT NULL,
