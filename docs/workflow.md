...
```json
{
  ...
  "rules": [
    ...
    {
      "match": "src/server/task-board/persistence/**",
      "action": { "kind": "fixed", "nodeTestDirs": ["tests/server/task-board"] }
    },
    ...
    {
      "match": "docker_image/**",
      "action": { "kind": "fixed", "nodeTestDirs": ["tests/server/agents/task-container"] }
    },
    ...
    {
      "match": "config/prompts.md",
      "action": { "kind": "fixed", "nodeTestDirs": ["tests/server/agents/task-worker"] }
    },
