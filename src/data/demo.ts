...
export const initialApprovals: ApprovalItem[] = [
  {
    ...
    confirmationPhrase: 'DEPLOY STW-482',
    release: {
...
export const initialAudit: AuditItem[] = [
  ...
  },
  {
    ...
    detail: 'Single-use approval consumed by the deployment broker.',
  ...
  },
  {
    ...
    actor: 'Policy engine',
    actorType: 'system',
    action: 'blocked agent deployment attempt',
    target: 'STW-465',
    detail: 'Software engineer identity lacks deploy_production capability. No command executed.',
