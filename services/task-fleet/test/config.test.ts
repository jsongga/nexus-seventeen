...
import { loadTaskFleetConfig, parseTaskFleetConfig } from "../src/config.js";
...
test("rejects ambiguous, duplicated, unsafe, and unbounded fleet configuration", () => {
  const cases: Array<readonly [string, (value: Record<string, unknown>) => void, RegExp]> = [
    ...
    ["unroutable agent", (value) => { (value.agents as Array<Record<string, unknown>>)[0]!.agentId = "engineering/platform"; }, /URL-safe path-segment/u],
